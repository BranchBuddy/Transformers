from src.Analyzer import extract_java_function_names, extract_python_function_names, extract_python_functions_from_source, extract_java_functions_from_source, extract_functions
...
def test_extract_python_functions_from_source():
    file = """
def jack_work():
    print('.........................')
def jack_not_work():
    ...
    matching_functions = extract_python_functions_from_source(file, function_names)
...
def test_extract_java_functions_from_source():
    source_code = """
    ...
    definitions = extract_java_functions_from_source(source_code, function_names)
